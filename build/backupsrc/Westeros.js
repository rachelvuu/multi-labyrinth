...
class Westeros {
    ...
    makeLannister() {
        ...
        let lannisterItem = new Item_1.Item("Gold Coins");
        return new Area_1.Area("Lannister", lannisterTitle, lannisterDescription, lannisterItem);
    }
    makeReach() {
        let tyrellTitle = "House Tyrell of the Reach";
        let tyrellDescription = "\n \nHouse Tyrell of Highgarden is an extinct Great House of Westeros. \nIt ruled over the Reach, a vast, fertile, \n and heavily-populated region of southwestern Westeros, \nfrom their castle-seat of Highgarden as Lords Paramount of the Reach and Wardens of \n the South. \n They have House Lannister to the North and Kinglandding to West";
        let tyrellItem = new Item_1.Item("Food");
        return new Area_1.Area("", tyrellTitle, tyrellDescription, tyrellItem);
    }
    makeStormlands() {
        let title = "House Boratheon of the Stormlands";
        ...
        return new Area_1.Area("", title, description);
    }
    makeKingsLanding() {
        let title = "The Capital";
    ...
    makeReverside() {
        ...
        let item = new Item_1.Item("Horses");
        return new Area_1.Area("", title, description, item);
    }
    makeEyrie() {
        let title = "House Arryn";
        ...
        let item = new Item_1.Item("Clothes");
        return new Area_1.Area("", title, description, item);
    }
    makeNorth() {
        let title = "House Stark";
        ...
        let item = new Item_1.Item("Dragons");
        return new Area_1.Area("", title, description, item);
    }
    getWesteros() {
        let westeros = new Set();
